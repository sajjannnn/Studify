      ...
      >
        ...
        <div className="space-y-6">
          ...
          <h2 className="text-4xl font-bold leading-tight text-white">
            Welcome back to your<br />AI study assistant
          </h2>
          <p className="text-lg text-white/70 max-w-md">
            Continue your learning journey. Access your AI-generated notes, documents, and personalized study feed.
          </p>
          <div className="flex gap-4">
            {["DU", "IPU", "B.Tech", "MBA"].map((tag) => (
              <span
                key={tag}
